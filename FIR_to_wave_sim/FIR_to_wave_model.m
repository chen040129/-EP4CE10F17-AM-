...
% ================================================================================
% Generated on: 06/04/2024 21:39:59
% Generated by: FIR Compiler II 18.0
%---------------------------------------------------------------------------------------------------------
%
...
for j = 1:sx
    ...
    %
    file_name = ['FIR_to_wave_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = FIR_to_wave_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['FIR_to_wave_model_output'];
